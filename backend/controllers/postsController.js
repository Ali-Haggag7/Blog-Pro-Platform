...
module.exports.CreatePostCtrl = asyncHandler(async (req, res) => {
    ...
    const post = await Post.create({  // دي طريقه تانيه لعمل بوست جديد فالداتابيز والطريقه دي بتعمل حفظ لوحدها مش لازم اعملها حفظ فالاخر
...
module.exports.deletePostCtrl = asyncHandler(async (req, res) => {
    ...
    if (req.user.isAdmin || req.user.id === post.user.toString()) {
        ...
        await Comment.deleteMany({ postId: post._id })  // ويشوف كل كومنت البوست ايدي بتاعه يساوي ايدي البوست ده ويمسحه databaseهيروح لل
